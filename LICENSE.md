...
Making this repository public does not grant a general license to its
contents. The applicable terms depend on the path:
...
| `vendor/wyst-design/`, `vendor/wyst-reference/`, `vendor/wyst-homepage-semantic-tokens.json`, and `tests/fixtures/wyst/` | Snapshot material from `wystlang/wyst`, offered under your choice of [MIT](LICENSE-MIT) or [Apache-2.0](LICENSE-APACHE). |
...
other brand assets to imply an official or endorsed project. Contact the Wyst
maintainers before reuse beyond nominative reference.
