...
test("design catalog links use authenticated local or pinned upstream artifacts", () => {
	...
	const rendered = makeMd({ wystSourceCommit: commit }).render(
		"[syntax words](syntax-words.tsv) [attributes](attribute-catalog.tsv) [C operation adapters](c-operation-adapter-catalog.tsv) [snapshot inputs](language-snapshot-inputs-v1.txt) [meta operations](meta-operation-catalog.tsv) [raw forms](a64-raw-encoding-source-forms.jsonl.gz) [semantic database](semantic-db.json)\n",
	);
